...
<body>
    ...
    <div class="d-none d-sm-block">
        <div class="row" style="background-color: #3b5998;">
            <div class="col-md-3">
                <img src="{{asset('image\logo.png')}}" class="img">
            </div>
            <div class="col-md-9">
                <div class="tab">
                    <table>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="mid">
                    ...
                    <img src="{{ asset('image\connect.png') }}" height="250px">
                </div>
            </div>
            <div class="col-md-6">
                <div class="midl">
...
<div class=" d-md-none">
    <div class="d-block d-sm-none ">
        <div class="row">
            <div class="col-12 np" >
                <img id="imgl" src="{{asset('image\logo.png')}}" class="" height="30px" style="padding-left: 20px;">
            </div>
        ...
        <div class="row">
                <div class="col-12 mm" style="background-color: #dfe1ee; height: 400px; margin-top: 0px;">
                    <div id="centerf">
                        <table>
                            <tr>
                                <td >
                                    <input type="text" class="txtd" placeholder="Email address or phone number">
                                </td>
                            </tr>
                            <tr>
                                <td><input type="text" class="txtdd" placeholder="Password"></td>
                                
                            </tr>
                            <tr>
                                <td>
                                    <button type="submit" style=" background-color:#4267B2;  color: white;" id="btnll">Log in</button>
                                </td>
                            </tr>
                        </table>
                        <br>
                        <button type="submit" id="btnc" >Create New Account</button>
                        <br>
                        <br>
                        <a href="" style=" color: rgb(78, 78, 173); font-size: small; margin-left: 120px;"">Forgotten passwor? help</a>
